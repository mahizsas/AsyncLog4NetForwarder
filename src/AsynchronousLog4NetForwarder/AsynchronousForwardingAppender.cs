...
{
    public class AsynchronousForwardingAppender : ForwardingAppender
    {
        ...
        private static readonly Type ThisType = typeof(AsynchronousForwardingAppender);

        private readonly LoggingEventHelper loggingEventHelper = new LoggingEventHelper("AsynchronousForwardingAppender", DefaultFixFlags);
        ...
        private void StopForwarding()
        {
            ...
            if (!hasFinishedFlushingBuffer)
            {
                ...
                ForwardInternalError("Unable to flush the AsynchronousForwardingAppender buffer in the allotted time, forcing a shutdown", null);
            }
        }
        ...
        private void InitializeBuffer()
        {
            lock (bufferLock)
            {
                ...
                {
                    // TODO: allow on the fly buffer size change without data loss
