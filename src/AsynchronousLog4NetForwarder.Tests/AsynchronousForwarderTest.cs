...
namespace AsynchronousLog4NetForwarder.Tests
{
    [TestFixture]
    public class AsynchronousForwarderTest
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            asynchronousForwardingAppender = new AsynchronousForwardingAppender();
            asynchronousForwardingAppender.AddAppender(debugAppender);
            asynchronousForwardingAppender.ActivateOptions();

            repository = LogManager.CreateRepository(Guid.NewGuid().ToString());
            BasicConfigurator.Configure(repository, asynchronousForwardingAppender);
        ...
        public void CanHandleNullLoggingEvent()
        {
            ...
            // Act
            asynchronousForwardingAppender.DoAppend((LoggingEvent)null);
            log.Info("SusequentMessage");
            asynchronousForwardingAppender.Close();
        ...
        public void CanHandleAppenderThrowing()
        {
            ...
            asynchronousForwardingAppender.AddAppender(badAppender);
        ...
        public void WillLogBufferOverflowWhenItHappens()
        {
            ...
            asynchronousForwardingAppender.BufferSize = 100;
        ...
        public void ThreadContextPropertiesArePreserved()
        {
            ...
            Assert.That(asynchronousForwardingAppender.Fix & FixFlags.Properties, Is.EqualTo(FixFlags.Properties), "Properties must be fixed if they are to be preserved");
        ...
        public void MessagesExcludedByFilterShouldNotBeAppended()
        {
            ...
            asynchronousForwardingAppender.AddFilter(levelFilter);
